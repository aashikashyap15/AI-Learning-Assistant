      ...
      <div className="space-y-8">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-6">
          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-neutral-700 mb-1.5">
                {/* Fixed: <lable> → <label>, "bold" class removed (use font-medium) */}
                Current Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div>
              <label className="block text-xs font-medium text-neutral-700 mb-1.5">
                {/* Fixed: <lable> → <label>, moved inside <div> */}
                New Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input
                  type="password"
                  value={newPassword}
                  // Fixed: values={...} → value={...}, onChange arrow fn syntax
                  onChange={(e) => setNewPassword(e.target.value)}
                  required
                  className="w-full h-9 pl-9 pr-3 border border-neutral-200 rounded-lg bg-white text-sm text-neutral-900 placeholder-neutral-400 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent"
                  // Fixed: "tect-sm" → "text-sm", added missing "border" before "border-neutral-200"
                />
              </div>
            </div>
