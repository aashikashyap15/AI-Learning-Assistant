...
import Flashcard from "../../components/common/flashcards/Flashcard";
    ...
    <div>
      <div className="mb-4">
        <Link
          ...
          className="inline-flex item-center gap-2 text-sm text-neutral-600 hover:text-neutral-900 transition-colors"
        >
          <ArrowLeft size={16} />
          Back to Document
        </Link>
