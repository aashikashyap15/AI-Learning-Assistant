...
const FlashcardSetCard = ({ flashcardSet }) => {
 ...
 return  <div
    ...
    className="group relative bg-white/80 backdrop-blur-xl border-2 border border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col justify-between"
    onClick={handleStudyNow}
  >
    <div className="space-y-4">
      {/* Icon and Title */}
      <div className="flex items-start gap-4">
        <div className="shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-emerald-100 to teal-100 flex item-center justify-center">
      ...
      {/* Stats */}
        ...
        <div className="space-y-2">
            ...
            <div
                className="absolute insert-y-0 left-0 bg-linear-to-r from emerald-500 to teal-500 rounded-full transition-all duration-500 ease-out"
    ...
    >
            ...
            <div className="absolute insert-0 bg-linear-to-r from-white/0 via-white/20 to white/0 -translate-x-full group-hover/btn: translate-x-full transition-transform duration-700" />
        </button>
         </div>
    </div>
